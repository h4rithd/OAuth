package com.shapmanasick.oauth.facebookapp.servlet;
...
import com.shapmanasick.oauth.facebookapp.data.ResourceDataHolder;
import com.shapmanasick.oauth.facebookapp.util.FileOperations;
...
// Detect the presence of an authorization code
        ...
        if (authorizationCode != null && authorizationCode.length() > 0) {
            ...
            final String CLIENT_ID = "226607424740444";
            final String CLIENT_SECRET = "9dde33c4087fc7bb8e2bdba1e7c3700f";
